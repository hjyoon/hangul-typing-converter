...
document.addEventListener('DOMContentLoaded', () => {
  const src    = document.getElementById('txtSource');
  const dest   = document.getElementById('txtConv');
  const btnC   = document.getElementById('btnClear');
  const btnCp  = document.getElementById('btnCopy');
  const optHtoE= document.getElementById('optHtoE');
  const optEtoH= document.getElementById('optEtoH');

  function doConvert() {
    dest.value = optEtoH.checked
      ? engTypeToKor(src.value)
      : korTypeToEng(src.value);
  }
  function clearText() {
    src.value = '';
    dest.value = '';
  ...
  src.addEventListener('keyup', doConvert);
  btnC.addEventListener('click', clearText);
  btnCp.addEventListener('click', copyResult);
  optHtoE.addEventListener('change', doConvert);
  optEtoH.addEventListener('change', doConvert);
